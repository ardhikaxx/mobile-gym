...
class _WorkoutPlanPageState extends State<WorkoutPlanPage> {
  ...
  final Map<String, dynamic> featuredWorkout = {
    "title": "Full Body Strength",
    "subtitle": "Compound Exercises for Maximum Gains",
    "duration": "60 min",
    "calories": "480 kcal",
    "level": "Intermediate",
    "levelColor": PurplePalette.accent,
    "exercises": 10,
    "rating": "4.7",
    "description":
        "A balanced workout combining equipment-based and bodyweight exercises for full body development.",
  };
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      ...
                      colors: [
                        PurplePalette.cardBackground,
                        PurplePalette.eggplant.withOpacity(0.7),
                      ],
                    ),
                    borderRadius: BorderRadius.circular(20),
                    border: Border.all(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: PurplePalette.accent.withOpacity(0.2),
                        blurRadius: 15,
                        spreadRadius: 2,
                      ...
                      children: [
                        Row(
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: featuredWorkout["levelColor"],
                                borderRadius: BorderRadius.circular(12),
                              ),
                              child: Text(
                        ...
                        Row(
                          children: [
                            _buildWorkoutInfo(
                              ...
                              "${featuredWorkout["exercises"]} exercises",
                            ),
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [
                                featuredWorkout["levelColor"],
                                featuredWorkout["levelColor"].withOpacity(0.8),
                              ],
                            ),
